export default {
  ...
  payment: {
    ...
    contactPlatforms: { telegram: 'Telegram', wechat: 'WeChat', wechat_work: 'WeChat Work', qq: 'QQ', email: 'Email' },
    contactRoles: { store: 'Store', support: 'Support', community: 'Community', channel: 'Channel', company: 'Company' },
