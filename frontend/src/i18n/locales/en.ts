  ...
  admin: {
    ...
    groups: {
      ...
      modelsModal: {
        ...
        description: 'Configure the model list shown for this group (display-only, has no effect on billing).',
        label: 'Model names (one per line, commas also allowed)',
        placeholder: 'claude-3-5-sonnet\nclaude-3-haiku\ngpt-4o',
        hint: 'Empty lines and whitespace are trimmed; duplicates removed. Save replaces the whole list.',
      },
