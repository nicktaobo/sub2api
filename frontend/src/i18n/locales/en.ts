export default {
  ...
  merchant: {
    ...
    detail: {
      ...
      groupPricing: {
        title: 'Group Pricing Overrides',
        description: 'Override the default markup for specific groups. Groups without an override fall back to the merchant default.',
        addOverride: 'Add Override',
        addTitle: 'Add Group Pricing',
        editTitle: 'Edit Group Pricing',
        group: 'Group',
        selectGroup: 'Select a group',
        confirmDelete: 'Delete the pricing override for this group?',
      },
    },
    owner: {
      ...
      pricing: {
        ...
        defaultMarkupHint: 'Groups without an individual setting use this default markup.',
        groupsTitle: 'Groups',
        groupsHint: 'All groups available for pricing (subscription-type groups are hidden — markup does not apply to them).',
        siteRate: 'Site Rate',
        myMarkup: 'My Markup',
        customLabel: 'Custom',
        inheritedLabel: 'Follows default',
        typePublic: 'Public',
        typeExclusive: 'Exclusive',
        editDefaultTitle: 'Edit Default Markup',
        editGroupTitle: 'Edit markup for {name}',
        markupHint: 'End-user price = main-site price × this markup. Must be ≥ 1; 1 means same price as the main site.',
        resetToDefault: 'Reset to default',
        confirmReset: 'Reset markup for {name} back to the default?',
      },
      domains: {
        title: 'Sites',
