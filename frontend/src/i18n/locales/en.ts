export default {
  ...
  admin: {
    ...
    channels: {
      ...
      bulkFill: {
        button: 'Fill from official pricing',
        title: 'Bulk fill from official pricing',
        description: 'Fill every pricing entry on this platform with its first model\'s official price × multiplier. Multi-model entries use the first model. Tiered intervals are untouched.',
        multiplier: 'Multiplier',
        multiplierHint: 'Final price = official × multiplier. e.g. 1.0 = official, 1.2 = +20%.',
        overwrite: 'Overwrite entries that already have prices',
        filling: 'Filling...',
        result: 'Filled {filled}; skipped {skipped}; no official price for {notFound}',
      },
