  ...
  admin: {
    ...
    channels: {
      ...
      bulkFill: {
        button: '按官方价批量填充',
        title: '按官方价批量填充',
        description: '本平台所有定价条目用各自第一个模型的官方价 × 倍率填充。多模型条目以第一个模型为准；阶梯定价不动。',
        multiplier: '倍率',
        multiplierHint: '最终价 = 官方价 × 倍率。例：1.0 = 官方价，1.2 = 加价 20%。',
        overwrite: '覆盖已有价格的条目',
        filling: '填充中...',
        result: '已填充 {filled} 条；{skipped} 条跳过；{notFound} 条无官方价',
      },
  ...
  merchant: {
    ...
    owner: {
      ...
      domains: {
        ...
        step1Hint: "HOST 填 {'@'} 代表根域名。如果你的 DNS 服务商自动拼接域名后缀，直接填 {'@'} 即可。",
        step2Title: '步骤二：添加 TXT 记录（验证域名所有权）',
        step2Hint: 'HOST 只填 _domain-verify，不要包含域名后缀。VALUE 需包含 domain-verify= 前缀。',
