export default {
  ...
  merchant: {
    ...
    detail: {
      ...
      groupPricing: {
        title: '分组定价覆盖',
        description: '为指定分组覆盖默认倍率；未配置的分组使用商户默认倍率。',
        addOverride: '新增覆盖',
        addTitle: '新增分组定价',
        editTitle: '编辑分组定价',
        group: '分组',
        selectGroup: '请选择分组',
        confirmDelete: '确认删除该分组的定价覆盖？',
      },
    },
    owner: {
      ...
      pricing: {
        ...
        defaultMarkup: '默认倍率',
        defaultMarkupHint: '未单独设置的分组都按此默认倍率加价。',
        groupsTitle: '分组列表',
        groupsHint: '所有可定价的分组（订阅型分组的 markup 不生效，已自动隐藏）。',
        siteRate: '主站倍率',
        myMarkup: '我的倍率',
        customLabel: '自定义',
        inheritedLabel: '跟随默认',
        ...
        editGroupTitle: '编辑 {name} 的倍率',
        markupHint: '终端用户付价 = 主站价 × 此倍率；倍率必须 ≥ 1，最低取 1 表示与主站同价。',
        resetToDefault: '重置为默认',
        confirmReset: '确定将 {name} 的倍率重置为默认值吗？',
      },
      domains: {
        title: '站点管理',
