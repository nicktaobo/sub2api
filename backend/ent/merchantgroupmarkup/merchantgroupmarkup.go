...
const (
	// Label holds the string label denoting the merchantgroupmarkup type in the database.
	Label = "merchant_group_markup"
	...
	// Table holds the table name of the merchantgroupmarkup in the database.
	Table = "merchant_group_markups"
	// MerchantTable is the table that holds the merchant relation/edge.
	MerchantTable = "merchant_group_markups"
...
// Columns holds all SQL columns for merchantgroupmarkup fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the MerchantGroupMarkup queries.
...
// ByMarkup orders the results by the markup field.
func ByMarkup(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldMarkup, opts...).ToFunc()
}
