...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.IdentityAdoptionDecision, c.Merchant, c.MerchantAuditLog, c.MerchantDomain,
		c.MerchantEarningsOutbox, c.MerchantGroupCost, c.MerchantGroupMarkup,
		c.MerchantLedger, c.MerchantWithdrawRequest, c.PaymentAuditLog, c.PaymentOrder,
...
type (
	hooks struct {
		...
		IdentityAdoptionDecision, Merchant, MerchantAuditLog, MerchantDomain,
		MerchantEarningsOutbox, MerchantGroupCost, MerchantGroupMarkup, MerchantLedger,
